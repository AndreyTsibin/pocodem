<?php get_header(); ?>
    ...
    <main class="content">
      ...
      <section class="main__slider">
        <img class="main__logo" src="./images/logo.svg" alt="Логотип">
        ...
        <div class="main__content-card-list">
          ...
          <div class="searchable">
            <a class="main__content-card" href="post/kak-zakrepit-shapku-v-zero.html">
              <img class="main__content-img" src="./images/timg1.svg" alt="Тильда">
          ...
          <div class="searchable">
            <a class="main__content-card" href="#">
              <img class="main__content-img" src="./images/timg2.svg" alt="Тильда">
          ...
          <div class="searchable">
            <a class="main__content-card" href="#">
              <img class="main__content-img" src="./images/timg3.svg" alt="Тильда">
      ...
      <section class="main__content">
        ...
        <div class="main__content-card-list">
          ...
          <div class="searchable">
            <a class="main__content-card" href="#">
              <img class="main__content-img" src="./images/js-1.svg" alt="JavaScript">
          ...
          <div class="searchable">
            <a class="main__content-card" href="#">
              <img class="main__content-img" src="./images/js-2.svg" alt="JavaScript">
          ...
          <div class="searchable">
            <a class="main__content-card" href="#">
              <img class="main__content-img" src="./images/js-3.svg" alt="JavaScript">
        ...
        <div class="main__content-card-list">
          ...
          <div class="searchable">
            <a class="main__content-card" href="post/generator-politiki.html">
              <img class="main__content-img" src="./images/g-1.svg" alt="JavaScript">
          ...
          <div class="searchable">
            <a class="main__content-card" href="#">
              <img class="main__content-img" src="./images/g-2.svg" alt="JavaScript">
          ...
          <div class="searchable">
            <a class="main__content-card" href="#">
              <img class="main__content-img" src="./images/g-3.svg" alt="JavaScript">
